...
stations <- data.frame(
  ...
  OS.X = sapply(lstations, function(x) x$OS.X),
  OS.Y = sapply(lstations, function(x) x$OS.Y),
...
stations$OS.Y <- as.numeric(stations$OS.X)
...
boroughs <- c("Newham", "Ealing", "Croydon", "Croydon", "City of London", 
              ...
              "Redbridge", "Hammersmith & Fulham", "Westminster", "Bromley", "Newham", 
              "Newham", "Barking and Dagenham", "Sutton", "Sutton", "Camden", 
              "Southwark", "Tower Hamlets", "Croydon", "Tower Hamlets", "City of Westminster", 
              ...
              "Enfield", "Barnet", "Merton", "Croydon", "City of Westminster", 
              ...
              "Kensington and Chelsea", "Hammersmith & Fulham", "Barnet", "Newham", "Tower Hamlets", 
              "Wandsworth", "Hillingdon", "Barnet", "City of Westminster", "City of Westminster", 
              "Havering", "Hertfordshire", "Lewisham", "City of Westminster", "Epping Forest", 
              "Reigate and Banstead", "Camden", "Epsom and Ewell", "Epsom and Ewell", "Redbridge", 
              "Croydon", "Barnet", "Camden", "Hammersmith & Fulham", "Newham", 
              "Redbridge", "Croydon", "Kensington and Chelsea", "Barnet", "Hammersmith & Fulham", 
              "Camden", "Epping Forest", "Croydon", "City of Westminster", "City of Westminster",
              "Redbridge", "Hammersmith & Fulham", "Hammersmith & Fulham", "Camden", "Elmbridge",
              ...
              "Hounslow", "City of Westminster", "Hillingdon", "Tower Hamlets", "Southwark",
              "Hammersmith & Fulham", "Brent", "Brent", "Newham", "Croydon", 
              "Camden", "Brent", "Reigate and Banstead", "Kensington and Chelsea", "Kensington and Chelsea",
              "Lambeth", "City of Westminster", "Tower Hamlets", "Kensington and Chelsea", "Croydon",
              "City of Westminster", "Waltham Forest", "Waltham Forest", "Croydon", "Newham",
              "Epping Forest", "City of Westminster", "Hackney", "City of London", "City of Westminster",
              ...
              "Hillingdon", "Hillingdon", "Kensington Chelsea", "Enfield", "Thurrock",
              "Hounslow", "Lambeth", "City of Westminster", "Ealing", "Hammersmith &  Fulham", 
              "Ealing", "Merton", "City of Westminster", "City of Westminster", "Harrow", 
              "Newham", "Newham", "Tower Hamlets", "Brent", "Newham",
              "Newham", "Thurrock", "Hammersmith & Fulham", "Brent", "Southwark",
              "Brent", "Lambeth", "City of Westminster", "Hertfordshire", "Havering",
              "Hammersmith & Fulham", "Harrow", "Redbridge", "Croydon", "Croydon",
              "City of Westminster", "Hertfordshire", "Epping Forest", "Newham", "City of Westminster",
              "Newham", "Hillingdon", "Hillingdon", "Hillingdon", "Camden",
              "Croydon", "Brentwood", "Hammersmith & Fulham", "Kensington and Chelsea", "Croydon",
              "Redbridge", "Ealing", "Harrow", "Kensington and Chelsea", "Tower Hamlets", 
              "Merton", "Redbridge", "Wandsworth", "Enfield", "Southwark", 
              "Merton", "Waltham Forest", "Lewisham", "Richmond", "Bromley",
              "City of Westminster", "City of Westminster", "City of London", "Hounslow", "Harrow",
              "Newham", "Tower Hamlets", "Lambeth", "Epsom and Ewell", "Newham",
              "Harrow", "Brent", "Sutton", "Camden", "Reigate and Banstead",
              "Reigate and Banstead", "City of Westminster", "Elmbridge", "Broxbourne", "Croydon",
              "Epping Forest", "Wandsworth", "Wandsworth", "City of Westminster", "Barnet",
              ...
              "City of Westminster", "Hertfordshire", "Hertfordshire", "Hertfordshire", "Croydon",
              "Brent", "Ealing", "Barnet", "Harrow", "Tower Hamlets", 
              "Hammersmith & Fulham", "Newham", "Kensington and Chelsea", "Tower Hamlets", "City of Westminster",
              "Hammersmith & Fulham", "Surrey", "Surrey", "Brent", "Merton", 
              "Haringey", "Hammersmith & Fulham", "Redbridge", "Croydon", "Barnet"
)
mergedStations$Borough[index] <- sapply(index, function(x) {
  mergedStations$Borough[x] <- boroughs[x]
})
...
if(mongo.is.connected(mongo) == TRUE) {
  ...
  mongo.insert.batch(mongo, STATIONS, bson) 
}
```